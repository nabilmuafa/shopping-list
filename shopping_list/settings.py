...
SECRET_KEY = 'django-insecure--e=81#!bqdtmt)!%f9)0fdtdc=!&2uti*d9=6h8l(vud)xo2=2'
...
STATIC_URL = 'shopping_list/static/'

STATIC_ROOT = os.path.join(BASE_DIR, 'shopping_list/static')

COMPRESS_ROOT = BASE_DIR / 'shopping_list/static'
